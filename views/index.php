...
<html lang="en">
    ...
    <body>
        ...
        <p>
            ...
            Загружайте файл через аплоадер, он переписывается в БД (сам файл попадает в папку <b>storage</b>).<br/>
            Можете загрузить сразу несколько <b>csv-файлов</b> за раз.<br/>
            Потом переходите в общую таблицу по ссылке внизу страницы.<br/>
        </p>
        <p>
            <b>Внимание!</b> К слову, кнопка <b>"Clear the table"</b> на табличной странице работает динамически через <b>AJAX</b>.
        </p>
        <?php
